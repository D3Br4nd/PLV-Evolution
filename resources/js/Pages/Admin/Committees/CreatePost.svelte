<script>
    ...
    function handleSubmit() {
        ...
        router.post(`/admin/committees/${committee.id}/posts`, formData, {
            onSuccess: () => {
                submitting = false;
...
<AdminLayout title="Nuovo Post - {committee.name}">
    <div class="space-y-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-bold tracking-tight">Nuovo Post</h1>
                <p class="mt-1 text-muted-foreground">
                    Pubblica un nuovo messaggio nella bacheca di <strong
