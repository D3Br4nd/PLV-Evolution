<script>
    ...
    let featuredImagePreview = $state("");
    ...
    function handleSubmit() {
        ...
        router.post(
            `/admin/committees/${committee.id}/posts/${post.id}`,
            formData,
            {
                onSuccess: () => {
                    submitting = false;
...
<AdminLayout title="Modifica Post - {committee.name}">
    <div class="space-y-6">
        <div class="flex items-center gap-4">
            <Button
                ...
                title="Torna al comitato"
            >
                <ArrowLeftIcon class="size-4" />
            </Button>
            <div>
                <h1 class="text-3xl font-bold tracking-tight">Modifica Post</h1>
                <p class="mt-1 text-muted-foreground">
                    Aggiorna il messaggio nella bacheca di <strong
                        >{committee.name}</strong
                    >
                </p>
            </div>
        </div>
        ...
        <Card.Root>
            <Card.Content class="space-y-6 p-6">
                ...
                <div class="space-y-2">
                    ...
                    {:else if post.featured_image_url && !removeFeaturedImage}
                        <div class="relative inline-block">
                            <img
                ...
                <div class="space-y-2">
                    ...
                    {:else if post.attachment_url && !removeAttachment}
                        <div
                            class="flex items-center gap-2 rounded-lg border bg-muted/30 p-3"
                        >
                            <span class="flex-1 truncate text-sm">
                                {post.attachment_name || "Allegato esistente"}
                            </span>
                            <Button
                                type="button"
                                variant="ghost"
